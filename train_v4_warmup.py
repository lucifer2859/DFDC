...
for epoch in range(n_epochs):
    ...
    if epoch < warmup_epochs:
      for p in optimizer.param_groups:
        p['lr'] = (epoch + 1) * best_lr / warmup_epochs
      train_model(epoch, optimizer, scheduler=None, history=history)
      loss = evaluate_model(epoch, scheduler=None, history=None)
    else:
      train_model(epoch, optimizer, scheduler=None, history=history)
    ...
    if loss < best:
      ...
      torch.save(model.state_dict(), f'/home/dchen/DFDC/models/model_v16.pth')
